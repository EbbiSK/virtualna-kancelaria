  ...
  return (
    <main className="flex flex-col items-center px-6 pt-[70px] text-center">
      ...
      <div className="flex gap-6">
        <button
          onClick={openRooms}
          className="group flex h-[230px] w-[390px] flex-col items-center justify-center rounded-[24px] border border-slate-200 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.13)]"
        >
